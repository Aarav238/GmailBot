...
export default function Dashboard() {
  ...
  const fetchActivity = useCallback(async () => {
    const r = await fetch("/api/bot/activity", { credentials: "include" });
  ...
  // Interval validation — computed fresh on every render
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background-light text-slate-900">
      ...
      {/* ── Sidebar ── */}
      <aside className="w-64 shrink-0 border-r border-slate-200 bg-white flex flex-col justify-between p-6">
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="text-slate-500 mt-1">Monitor and control your Gmail auto-reply bot.</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {/* Status card */}
              <div className="lg:col-span-2 bg-white rounded-xl p-6 border border-slate-200 shadow-sm flex flex-col md:flex-row gap-6 items-center">
                <div className="flex-1 space-y-4">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-xl font-bold">{status.botEnabled ? "Bot is Active" : "Bot is Paused"}</p>
                    </div>
                ...
                {/* Success rate block */}
                <div className="w-full md:w-44 shrink-0 flex flex-col items-center justify-center gap-2 rounded-xl border border-slate-100 bg-slate-50 p-5">
                  <p className="text-xs text-slate-400 uppercase tracking-wide">Success Rate</p>
                  <p className="text-4xl font-extrabold" style={{ color: "#137fec" }}>{status.successRate}%</p>
              ...
              {/* Replies highlight */}
              <div className="text-white rounded-xl p-6 shadow-lg flex flex-col justify-between" style={{ backgroundColor: "#137fec" }}>
                ...
                <div>
                  ...
                  <h3 className="text-5xl font-bold mt-1">{status.replyCount}</h3>
                  <div className="mt-4 pt-4 border-t border-white/20">
                    <p className="text-xs opacity-80">Last Checked</p>
                    <p className="text-xl font-semibold">{fmtTime(status.lastRun)}</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  {activity.map((item, i) => (
                    <div key={i} className="p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold truncate max-w-xs">{item.subject}</p>
                          <p className="text-xs text-slate-500 truncate max-w-xs">{parseName(item.from)}</p>
                        </div>
                      </div>
